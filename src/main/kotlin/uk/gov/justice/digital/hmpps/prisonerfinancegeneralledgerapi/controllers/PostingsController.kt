...
class PostingsController(
  ...
  fun getPostingsFromAccountId(@PathVariable accountId: UUID): ResponseEntity<List<StatementEntryResponse>> = ResponseEntity<List<StatementEntryResponse>>.status(200).body(postingService.listStatementEntries(accountId))
}
